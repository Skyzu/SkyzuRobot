...
import SkyzuRobot.modules.sql.global_bans_sql as gban_sql
import SkyzuRobot.modules.sql.users_sql as user_sql
from SkyzuRobot import DEV_USERS, OWNER_ID, dispatcher
